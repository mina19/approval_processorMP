...
echo "Checking out branch ignoreOfflineTriggers in approval_processorMP"
cd ${APPROVAL_PROCESSORMP_DIR}
git checkout -b ignoreOfflineTriggers origin/ignoreOfflineTriggers
...
cd ${APPROVAL_PROCESSORMP_DIR}/test/offlineTriggers
