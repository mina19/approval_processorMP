...
CONFIG_FILE=${REPO_DIR}/approval_processorMP/test/pipelineThrottle/cwb.ini_1           # config file of the event created, will be written by script
...
IDQ_RESPONSE=0		# Pass/ fail criteria AP's IDQ threshold
