...
CONFIG_FILE=${REPO_DIR}/approval_processorMP/test/pipelineThrottle/gstlal.ini_3         # config file of the event created, will be written by script
NUM_EVENTS=3		# number of this type of events to be created
