...
CONFIG_FILE=${REPO_DIR}/approval_processorMP/test/grouper/cwb.ini_1             # config file of the event created, will be written by script
...
VIRGOINJ=1		# 0 for DID NOT FIND injections; 1 for DID FIND injections
